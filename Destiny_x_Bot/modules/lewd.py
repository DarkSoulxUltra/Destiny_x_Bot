...
from Destiny_x_Bot import dispatcher, updater
import Destiny_x_Bot.modules.sql.nsfw_sql as sql
from Destiny_x_Bot.modules.log_channel import gloggable
...
ADD_NSFW_HANDLER = CommandHandler(["addnsfw","iwannacum"], add_nsfw)
REMOVE_NSFW_HANDLER = CommandHandler(["rmnsfw","iamdonenow"], rem_nsfw)
