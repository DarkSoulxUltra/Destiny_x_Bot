...
def user_admin(func):
    ...
    def is_admin(update: Update, context: CallbackContext, *args, **kwargs):
        ...
        if user and is_user_admin(chat, user.id):
            ...
            update.effective_message.reply_text(
                "Bruh!!! You are not an admin, want me to throw a D2 at you?",
            )
...
def bot_can_delete(func):
    ...
    def delete_rights(update: Update, context: CallbackContext, *args, **kwargs):
        ...
        if update_chat_title == message_chat_title:
            cant_delete = "Huh!! Make me admin first, then I will destroy this message ASAP!!!"
        else:
            cant_delete = f"Huh!! Make me admin first in <b>{update_chat_title}</b>!\n, then I will destroy this message ASAP!!!"
...
def user_can_ban(func):
    ...
    def user_is_banhammer(update: Update, context: CallbackContext, *args, **kwargs):
        ...
        if (
            ...
            update.effective_message.reply_text(
                "Gomenne!!! But you are not a conductor like my Maestro.",
            )
            return ""
        return func(update, context, *args, **kwargs)
...
from Destiny_x_Bot.modules import connection
