...
from Destiny_x_Bot.modules.disable import DisableAbleMessageHandler
from Destiny_x_Bot.modules.helper_funcs.regex_helper import infinite_loop_check
        ...
        try:
            ...
            if check and check.group(0).lower() == to_fix.lower():
                update.effective_message.reply_to_message.reply_text(
                    ...
                    "say! Such a perv.".format(update.effective_user.first_name),
                )
                return
