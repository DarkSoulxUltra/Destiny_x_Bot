...
import Destiny_x_Bot.modules.sql.global_bans_sql as gban_sql
import Destiny_x_Bot.modules.sql.users_sql as user_sql
from Destiny_x_Bot import DEV_USERS, OWNER_ID, dispatcher
