...
from Destiny_x_Bot.modules.helper_funcs.msg_types import Types
from Destiny_x_Bot.modules.sql import BASE, SESSION
from sqlalchemy import BigInteger, Boolean, Column, Integer, String, UnicodeText

DEFAULT_WELCOME = "Hey {first}, how are you doing?"
DEFAULT_GOODBYE = "Nice knowing ya!"

DEFAULT_WELCOME_MESSAGES = [
    "{first} is here!",  # Discord welcome messages copied
    "Ready player {first}",
    "Maestro, {first} is here.",
    "A wild {first} appeared.",
    "{first} came in like a Lion!! I prefer Tigers more.",
    "{first} has joined the party. Now gib party ;)",
    "{first} just joined. Can I get a heal? Onegaiii",
    ...
    "Welcome, {first}. We hope you brought a pizza.",
    "Welcome, {first}. Leave your weapons by the door, Or I will consider you a D2",
    "Swoooosh. {first} just landed.",
    "Brace yourselves. {first} just joined the chat.",
    "{first} just joined. Hide your Melons... ladies.",
    "{first} just arrived. Seems OP like me - please nerf.",
    "{first} just slid into the chat.",
    "A {first} has spawned in the chat.",
    "Hmm, {first} showed up!",
    "Baba, Blackship, have you any wool. {first} just joined, now don't be a fool!!!"
    ...
    "Hey {first}, do you wanna know how I got these scars? - Yeah, my Maestro did it with me.",
    ...
    "I Believe My Maestro Will Be Victorious! ...",
    ...
    "I'm Gonna Destroy Them! Every last one of those D2's thats on this land",
...
DEFAULT_GOODBYE_MESSAGES = [
    "{first} will be missed. Sort of...",
    "{first} just went offline.",
    "{first} has left the lobby.",
    "{first} has left the clan.",
    "{first} has left the game.",
    "{first} has fled the area. May be {first} was a D2 and got scared of me.",
    ...
    "Think for yourself",
    "Question authority",
    "You are worshiping a Sun God from a Moon Temple.",
    "Don't leave the house today",
    "Give up!",
    "Marry and Reproduce.. Lmao, not with me. Find a girl.",
    "Stay asleep",
    "Wake up. Ohh! you went into hibernate mode.",
    "Look to la luna",
    "Steven lives",
