...
from Destiny_x_Bot import (DEV_USERS, OWNER_ID, DRAGONS, SUPPORT_CHAT, DEMONS,
                          TIGERS, WOLVES, dispatcher)
import Destiny_x_Bot.modules.sql.feds_sql as sql
...
from Destiny_x_Bot.modules.helper_funcs.string_handling import markdown_parser
...
def fed_ban(update: Update, context: CallbackContext):
    ...
    if int(user_id) in DEMONS:
        message.reply_text("D2 Slayers cannot be fed banned!")
        return
