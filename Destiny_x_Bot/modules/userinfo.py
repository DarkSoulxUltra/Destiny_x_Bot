...
from Destiny_x_Bot.__main__ import STATS, TOKEN, USER_INFO, get_readable_time
import Destiny_x_Bot.modules.sql.userinfo_sql as sql
from Destiny_x_Bot.modules.disable import DisableAbleCommandHandler
from Destiny_x_Bot.modules.sql.global_bans_sql import is_user_gbanned
from Destiny_x_Bot.modules.sql.afk_sql import is_afk, check_afk_status
from Destiny_x_Bot.modules.sql.users_sql import get_user_num_chats
from Destiny_x_Bot.modules.helper_funcs.chat_status import sudo_plus
from Destiny_x_Bot.modules.helper_funcs.extraction import extract_user
from Destiny_x_Bot import telethn as DestinyTelethonClient
...
def info(update: Update, context: CallbackContext):
    ...
    if user.id == OWNER_ID:
        ...
        text += "\n\nThe Disaster level of this person is 'Defender', a Tiger."
        disaster_level_present = True
    elif user.id in WOLVES:
        text += "\n\nThe Disaster level of this person is 'Melody Creator', a wolf."
        disaster_level_present = True
