...
from Destiny_x_Bot.modules import ALL_MODULES
import Destiny_x_Bot.modules.sql.users_sql as sql
from Destiny_x_Bot.modules.helper_funcs.chat_status import is_user_admin
from Destiny_x_Bot.modules.helper_funcs.misc import paginate_modules
...
GROUP_START_IMG = "https://telegra.ph/file/6931b8ee3a04aef8af314.mp4"

UNMEI_PHOTO = "https://telegra.ph/file/f038c58b72c34d722a6ae.jpg"
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("Destiny_x_Bot.modules." + module_name)
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_animation(
            GROUP_START_IMG, caption= "I won't sleep because I believe someone is waiting for your music.:</b> <code>{}</code>".format(
                uptime
            ),
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                text="Help",
                                url="t.me/Destiny_x_Bot?start=ghelp_{}".format(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="Help",
                            url="t.me/Destiny_x_Bot?start=help".format(context.bot.username),
                        ),
                    ],
                ],
            ),
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 866830519 and DONATION_LINK:
            update.effective_message.reply_text(
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "[hey! I am back from OYO!!](https://telegra.ph/file/5543dfa41fe351e2d66b7.jpg)", parse_mode=ParseMode.MARKDOWN)
        except Unauthorized:
            LOGGER.warning(
    ...
    if WEBHOOK:
        ...
        LOGGER.info("Unmei bot is deployed successfully!")
